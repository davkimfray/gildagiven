...
import ViewPost from "./views/pages/blog/ViewPost";
  ...
  const { isLoggedIn, isLoading} = useSession();
    if (isLoading) {
      return (
          ...
          // <div className="d-flex justify-content-center align-items-center font-heading pt-3 text-center position-absolute main-bg w-100 h-100">
          //     <h1>loading ...</h1>
      ...
      <BrowserRouter>
          <React.Suspense fallback={loading}>
            <Switch>
              ...
              <Route exact path="/blog/post/:postKey" name="View Post" render={props => <ViewPost {...props}/>} />
              ...
              <Route exact path="/500" name="Page 500" render={props => <Page500 {...props}/>} />
                <Route exact path="/admin/login" name="Login Page" render={
                    props => isLoggedIn ?  <Redirect to="/admin"/> : <Login {...props}/>} />
                {/*<Route exact={} path="/admin/login" name="Login" render={props => <Login {...props}/>} />*/}
              <Route path="/admin" name="Admin" render={
                 props => isLoggedIn ? <TheLayout {...props}/> : <Redirect to="/admin/login"/>} />
            </Switch>
